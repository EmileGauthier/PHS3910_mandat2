...
% Input : positions (une matrice N par 2 contenant les coordonnées de tous les fits gaussiens, pour une marche aléatoire complète).
%         max_lag (saut maximal entre frames qu'on souhaite évaluer)
